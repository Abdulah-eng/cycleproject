...
export default function EditProductForm({ bike }: EditProductFormProps) {
  ...
  const [formData, setFormData] = useState({
    ...
    // Score explanations
    overall_score_explanation: bike.overall_score_explanation || '',
    performance_score_explanation: bike.performance_score_explanation || '',
    value_score_explanation: bike.value_score_explanation || '',
    fit_score_explanation: bike.fit_score_explanation || '',
    general_score_explanation: bike.general_score_explanation || '',
    climbing_efficiency_explanation: bike.climbing_efficiency_explanation || '',
    aerodynamics_explanation: bike.aerodynamics_explanation || '',
    riding_position_explanation: bike.riding_position_explanation || '',
    handling_explanation: bike.handling_explanation || '',
    fit_flexibility_explanation: bike.fit_flexibility_explanation || '',
    ride_comfort_explanation: bike.ride_comfort_explanation || '',
    build_quality_explanation: bike.build_quality_explanation || '',
    value_for_money_explanation: bike.value_for_money_explanation || '',
    surface_range_explanation: bike.surface_range_explanation || '',
  })
